...
jQuery("select#arret_travail").change(function(){

    var at = jQuery('#arret_travail').val();

    if(at == 1){
        jQuery('#debut_fin').slideDown();
        jQuery('#cause_arret').slideDown();
    }else{
        jQuery('#debut_fin').slideUp();
        jQuery('#cause_arret').slideUp();
    }
