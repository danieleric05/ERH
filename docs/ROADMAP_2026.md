# Roadmap 2026 - Projet ERH

**Dernière mise à jour:** 2026-01-27
**Version:** 2.0 (Fusionné : TODO + QUE_RESTE_T_IL_A_FAIRE)
**Audience:** Équipe de développement, Managers

---

## 📊 Vue d'ensemble

Cet document consolide toutes les tâches prioritaires du projet ERH pour l'année 2026, catégorisées par priorité et trimestre.

**Méthodologie:**
- 🔴 **PRIORITÉ HAUTE** : Blocker, dépendances critiques
- 🟡 **PRIORITÉ MOYENNE** : Important mais peut attendre 1-2 semaines
- 🟢 **PRIORITÉ BASSE** : Améliorations futures, pas critique
- ✅ **TERMINÉ** : Complètement réalisé et testé
...
✅ Architecture user/users clarifiée et documentée
```
...
✅ Fusion guides documentation (-40% redondance)
```
...
✅ Importation travailleurs/sanctions depuis CSV Sage
```

---

## 🔴 CETTE SEMAINE (Priorité HAUTE - Semaine 1)

### Tâche 1 : Valider le système de photos (3h) ✓ A tester
```
...
Fichiers concernés:
- EmployerController::post_travailleur_autres()
- EmployerController::post_edit_travailleur()
- travailleur/addautres.blade.php
- travailleur/edit.blade.php
```

**Résultat attendu:** Tous les tests unitaires passent + zéro regression

---

### Tâche 2 : Ajouter validation uploads (3h)
```
[ ] Dans EmployerController@post_travailleur_autres
    Ajouter : $request->validate(['photo' => 'nullable|image|mimes:jpeg,png,jpg|max:2048'])
...
**Résultat attendu:** Validation robuste en place + tests verts

---

### Tâche 3 : Décider du code archivé (2h)
```
[ ] Analyser l'usage de Précarité (HA01)
    ...
    ⭕ Supprimer définitivement (nettoyer code)
...
Résultat: Commit avec décision documentée
```

---

### Tâche 4 : Préparer tests utilisateurs (2h)
```
...
Script SQL: À créer
Documentation: GUIDE_TESTS_UTILISATEURS.md
```

---

## 🟡 SEMAINE PROCHAINE (Priorité MOYENNE - Semaine 2-3)

### Tâche 5 : Standardiser Font Awesome v6 (2h)
```
...
### Tâche 6 : Remplacer `<marquee>` obsolète (1h)
```
[ ] Dans home/contenu.blade.php ligne 31
    Remplacer : <marquee>VOUS AUREZ...</marquee>

    Par : Alpine.js avec animation
...
### Tâche 7 : Corriger contrastes WCAG (2h)
```
...
### Tâche 8 : Refactoriser contrôleurs (16h)
...
### Tâche 9 : Ajouter relations Eloquent (6h)
```
[ ] Modèle Travailleur
...
### Tâche 10 : Migrer pages Bootstrap → Tailwind (10h)
...
### Tâche 11 : Ajouter pagination (4h)
```
...
### Tâche 12 : Écrire tests automatisés (12h)
...
### Tâche 13 : Optimiser performance (8h)
```
...
### Tâche 14 : Améliorer sécurité (6h)
```
...
### Tâche 15 : Documentation utilisateur (8h)
```
...
[ ] Tester le système de photos (1h)
    - Suivre checklist Tâche 1
    - Noter les bugs éventuels
    - Créer des issues Git si nécessaire

[ ] Décider code archivé (30 min)
...
- `AUDIT_COMPLET_2026-01-26.md` - Analyse technique détaillée
- `GUIDE_ACTIONS_PRIORITAIRES_2026-01-26.md` - Actions hebdomadaires
- `ETAT_ACTUEL_PROJET.md` - État snapshot du projet
- `CLAUDE.md` - Guide conventions et architecture
