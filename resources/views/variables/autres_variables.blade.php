        ...
        <form action="{{ url('post_autres_variables') }}" method="POST" class="form-auth-small">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                    ...
                    <input name="date_variable" id="date_variable" type="date" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-accent">
                </div>
            </div>
