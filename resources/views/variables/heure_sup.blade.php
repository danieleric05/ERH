    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <form action="{{ url('post_variables_heure_sup') }}" method="POST" role="form">
    @csrf
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select multiple name="employer_hs[]" class="form-control show-tick ms select2" data-placeholder="Select">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Type H.S</label>
                                <select name="heure_hs" class="form-control show-tick ms select2" data-placeholder="Select">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="nbre_heure_hs" class="form-control show-tick ms select2" data-placeholder="Select">
                                    <option value="">-DEROULER-</option>
