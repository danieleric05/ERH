        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
            <div class="text-center">
                <a href="{{ route('listesanctions') }}">
                    <div class="bg-orange-50 rounded-lg shadow-lg-soft border-t-4 border-slate-900 p-5 h-full flex flex-col justify-between">
                        <div class="text-center mb-4">
                            <img height="90" src="{{ asset('rhassets/images/images.png') }}" class="rounded-full h-24 w-24 object-cover mx-auto" alt="">
                        </div>
            ...
            <div class="text-center">
                <a href="{{ url('variables') }}">
                    <div class="bg-red-100 rounded-lg shadow-lg-soft border-t-4 border-red-500 p-5 h-full flex flex-col justify-between">
                        <div class="text-center mb-4">
                            <img height="90" src="{{ asset('rhassets/images/images.png') }}" class="rounded-full h-24 w-24 object-cover mx-auto" alt="">
                        </div>
            ...
            <div class="text-center">
                <div class="bg-blue-100 rounded-lg shadow-lg-soft border-t-4 border-plastica-blue p-5 h-full flex flex-col justify-between">
                    <div class="text-center mb-4">
                        <img height="90" src="{{ asset('rhassets/images/images.png') }}" class="rounded-full h-24 w-24 object-cover mx-auto" alt="">
                    </div>
