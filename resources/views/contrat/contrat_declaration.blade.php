    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="text-center">
                <img src="{{ asset('rhassets/images/entete.jpg') }}"  height="105" width="720">
            </div>
            <br/>
            <div class="text-center" style="text-align: center; font-weight: bold"> (1) &nbsp; &nbsp; &nbsp; <b>x</b> Embauche &nbsp; &nbsp; &nbsp; Modification &nbsp; Cessation d’Emploi &nbsp;&nbsp;&nbsp;&nbsp;  </div>
            <br/>
