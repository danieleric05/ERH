...
<body>
    ...
    $nomComplet = strtoupper($travailleur->nom ?? '') . ' ' . strtoupper($travailleur->prenoms_complets);
    ...
    <div class="section">
        <p class="article-title">Article 2 - NATURE ET DURÉE DU CONTRAT</p>
        Le présent contrat est conclu pour une durée déterminée de <span class="bold">12 (douze) mois</span>, du <span class="bold">{{ $tabDateDebut[2] }}/{{ $tabDateDebut[1] }}/{{ $tabDateDebut[0] }}</span> au <span class="bold">{{ $tabDateFin[2] }}/{{ $tabDateFin[1] }}/{{ $tabDateFin[0] }}</span>.
        <br><br>
        À son terme, le présent contrat pourra être renouvelé par voie d'avenant, conformément aux dispositions du Code du Travail et de la Convention Collective Interprofessionnelle de Côte d'Ivoire.
    </div>

    <div class="section">
        <p class="article-title">Article 3 - PÉRIODE D'ESSAI</p>
        Les trois (03) premiers mois du présent contrat sont considérés comme période d'essai. Durant cette période, chacune des parties pourra rompre le contrat sans préavis ni indemnité, conformément aux dispositions du Code du Travail.
    </div>
    ...
    <div class="section">
        <p class="article-title">Article 8 - OBLIGATIONS DU TRAVAILLEUR</p>
    ...
    <div class="section">
        <p class="article-title">Article 9 - RUPTURE DU CONTRAT</p>
        Le présent contrat prendra fin de plein droit à l'échéance du terme prévu.
        <br><br>
        Toutefois, il pourra être rompu avant terme en cas de faute grave ou lourde de l'une des parties, de force majeure, ou d'un commun accord entre les parties, conformément aux dispositions du Code du Travail.
    </div>

    <div class="section">
        <p class="article-title">Article 10 - CONGÉS PAYÉS</p>
