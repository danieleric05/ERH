...
<body>
    ...
    <div class="section">
        ...
        Le présent contrat de Travail est à <span class="bold">DURÉE INDÉTERMINÉE</span> qui commencera à courir à partir du <span class="bold">{{ $tabDateDebut[2] }}/{{ $tabDateDebut[1] }}/{{ $tabDateDebut[0] }}</span>. Il ne sera cependant confirmé qu'après une période d'essai de deux (2) mois jugée concluante par l'Employeur.
    </div>
