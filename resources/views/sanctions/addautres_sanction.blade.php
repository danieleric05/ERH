...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            <h1 class="text-3xl font-bold text-text-primary">Ajouter une Sanction (Non Inscrit)</h1>
    ...
    <div class="bg-white rounded-lg shadow-lg-soft p-8">
        <h2 class="text-xl font-bold text-text-primary mb-6">Formulaire de Sanction pour Employé Non Inscrit</h2>

        <form action="{{ url('post_sanction') }}" method="POST" x-data="initializeSanctionAutresForm()">
            @csrf
...
<script>
function initializeSanctionAutresForm() {
    return {
        sanctionApplique: '',
