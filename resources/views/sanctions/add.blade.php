            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <label>Date	de la faute</label>
                            <div class="input-group mb-3">
                                <input name="datefautes" style="height: 40px; color: black; font-weight: bold" value="{{ date('Y-m-d') }}" type="date" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <label>Quart concerné</label>
                            <select name="quarts" class="form-control show-tick ms select2" data-placeholder="Select">
								<option value="">-DEROULER-</option>
                        ...
                        <div style="display: none" id="nombre_jour" class="row col-sm-12">
							<div class="col-lg-3 col-md-6 col-sm-12">
								<label>Nombre de jour</label>
								<div class="input-group mb-3">
									<select name="nombre_jour" class="form-control show-tick ms select2" data-placeholder="Select">
										<option value="">-DEROULER-</option>
