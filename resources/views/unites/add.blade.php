                    ...
                    <table class="table table-hover js-basic-example dataTable table-custom">
                        ...
                        <tr>
                            ...
                            <td class="actions text-center">
                                <a href="{{ url('edit/unites/data') }}" data-id="{{ $listedata->id }}" id="edit" class="btn btn-sm btn-icon btn-pure btn-dark on-default button-remove" data-toggle="tooltip" data-original-title="Remove" aria-describedby="tooltip270584">
