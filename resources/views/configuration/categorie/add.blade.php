        ...
        <div class="row">
            <div class="col-lg-6 col-md-8 col-sm-12">
                <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth">
                        <i class="fa fa-arrow-left"></i></a> Liste des catégories </h2>
                <ul class="breadcrumb">
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <a onclick="addForm_categorie()"  style="float: right; color: #fff;" data-toggle="modal" data-target="#largeModal" style="float: right" class="btn btn-danger m-b-15 m-t-10 m-r-20">
                    <i class="icon wb-plus" aria-hidden="true"></i> Ajouter une catégorie
                </a>
                ...
                <div class="body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover js-basic-example dataTable table-custom">
                            ...
                            <tbody>
                            @foreach($data_categories as $listedata)
                                <tr>
                                    <td>{{ $listedata->label }}</td>
                                    <td class="actions text-center">
                                        <a href="{{ url('edit/categories/data') }}" data-id="{{ $listedata->id }}" id="edit" class="btn btn-sm btn-icon btn-pure btn-dark on-default button-remove" data-toggle="tooltip" data-original-title="Remove" aria-describedby="tooltip270584">
