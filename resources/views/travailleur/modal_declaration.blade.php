            ...
            <form action="{{ url('update/declarations/updatedeclaration') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select required name="actionid" id="actionid" class="form-control" data-placeholder="Select">
                                    ...
                                    <option value="5">DECLARATION CNPS</option>
                                    <option value="8">MODIFIER UNITE/EQUIPE</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12" style="display: none" id="uniteChoix">
                            <div class="form-group">
                                <label for="idunite" class="control-label">Unité</label>
                                <select name="uniteid" id="idunite" class="form-control">
                                    <option value="">-DEROULER-</option>
                                </select>
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 col-sm-12" style="display: none" id="uniteDepart">
                            <div class="form-group">
                                <label for="phone-ex" class="control-label">Departement</label>
                                <select name="departementid" id="departementid" class="form-control">
                                    <option value="">-DEROULER-</option>
                                </select>
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 col-sm-12" style="display: none" id="equipeChoix">
                            <div class="form-group">
                                <label for="equipeid" class="control-label">Equipe</label>
                                <select name="equipeid" id="equipeid" class="form-control select2-active">
                                    <option value="">-DEROULER-</option>
                                </select>
                            </div>
                        </div>
