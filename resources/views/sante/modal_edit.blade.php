<!-- Alpine.js Modal for Editing Consultation -->
<div x-data="modalEditSante()" @open-modal-edit.window="openModal($event)" class="fixed inset-0 z-50 flex items-center justify-center" x-show="isOpen" style="display: none;">
    <!-- Overlay -->
    ...
    <div class="relative bg-white rounded-lg shadow-2xl max-w-2xl w-full mx-4 overflow-hidden" @click.stop>
        ...
        <div class="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
            <h3 class="text-lg font-bold text-text-primary">Modifier la Consultation</h3>
        ...
        <!-- Form -->
        <form action="{{ url('update/sante/updatesante') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <textarea name="consultation" id="consultation" rows="4"
                        class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-accent"
                        x-model="consultation"></textarea>
                </div>
...
function modalEditSante() {
    return {
        ...
        openModal(event) {
            ...
            this.consultation = detail.consultation || '';
